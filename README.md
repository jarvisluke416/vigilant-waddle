...
Your current code makes SNARE a synthesized snare using both noise and a short tonal component, so you can place it at any beat position, including decimals like 1.25, 2.5, or 3.75. HIHAT, CLOSED_HIHAT, OPEN_HIHAT, OPENHIHAT, CLAP, LOW_TOM, MID_TOM, HIGH_TOM, CRASH, RIDE, RIMSHOT, COWBELL, SHAKER, TAMBOURINE
